...
module.exports = [
    ...
    {"html":[
        {"head": [
            ...
            {"script":{"src":"static/geodesyform.js"}},
            {"style": {
                ":root":{
                    "--radius": "100px",
                    "--globalscale": "1",
        ...
        {"body": [
            ...
            {"geodesy": {"id":"geodesy", "length":"4", "motif":"pyritohedron"}},
            {"form": [
                ...
                {"section group='3''":[
                    {"section":[
                        {"label for='zoom'":["zoom"]},
                        {"input for='zoom'": {"type":"range", "min":"-3","max":"3","step":"0.01" }},
                    ]},
                    {"section":[
                        {"label for='pan-x'":["pan x"]},
                        {"input for='pan-x'": {"type":"range", "min":"-5","max":"5","step":"0.01" }},
                    ]},
                    {"section":[
                        {"label for='pan y'":["pan y"]},
